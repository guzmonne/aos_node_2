...
function program1(depth0,data) {
  ...
  if (stack1 = helpers.technician_id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.technician_id); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"col-lg-12 hide\" id=\"report-buttons\">\n	<span id=\"printAppliancesPDF\" class=\" pull-right btn btn-info btn-sm btn-margin\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Imprimir Equipos\" style=\"margin-bottom: 5px;\">\n    <i class=\"fa fa-print fa-fw fa-lg\"></i>\n  </span>\n  <span id=\"downloadAppliancesPDF\" class=\" pull-right btn btn-info btn-sm btn-margin\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Descargar Equipos\" style=\"margin-bottom: 5px;\">\n    <i class=\"fa fa-download fa-fw fa-lg\"></i>\n  </span>\n</div>\n<div class=\"col-lg-12\">\n	<table id=\"appliances-table-";
  ...
  buffer += escapeExpression(stack1)
    + "\" class=\"table table-striped table-bordered table-condensed table-hover table-office table-condensed\" aria-describedby=\"appliances-table-info\">\n		<thead>\n			<tr>\n				<th>ID</th>\n				<th>Cliente</th>	\n				<th>Modelo</th>\n				<th>Marca</th>\n				<th>Serie</th>\n				<th>Tipo</th>\n				<th>Estado</th>\n				<th>Tecnico</th>\n				<th>Creado</th>\n				<th>Cerrado</th>\n				<th class=\"text-center\"><i class=\"fa fa-wrench\"></i></th>\n			</tr>\n		</thead>\n		<tbody role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\" id=\"appliances\">\n		</tbody>\n	</table>\n</div>\n";
  return buffer;
  });
...
function program8(depth0,data) {
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n</td>\n<td>\n	<h4 style=\"margin: 0px;\"><span class=\"label label-default ";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.statusClass || (depth0 && depth0.statusClass)),stack1 ? stack1.call(depth0, (depth0 && depth0.status), options) : helperMissing.call(depth0, "statusClass", (depth0 && depth0.status), options)))
    + "\">";
  if (stack2 = helpers.status) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\"></div>\n<div class=\"col-lg-12\">\n	<hr>\n  <div class=\"row\">\n    <div class=\"col-sm-6\">\n      <small>\n        Creado el <span name=\"createdAt\"></span> por <span name=\"createdBy\"></span>\n      </small>\n    </div>\n    <div class=\"col-sm-6 text-right\">\n      <small>\n        Modificado el <span name=\"updatedAt\"></span> por <span name=\"updatedBy\"></span>\n      </small>\n    </div>\n  </div>\n</div>";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\" class=\"table table-striped table-bordered table-hover table-office table-condensed\" aria-describedby=\"clients-table-info\">\n				<thead>\n					<tr>\n						<th>Datos</th>\n						<th>Telefono/s</th>\n						<th>Dirección/es</th>\n						<th class=\"text-center\"><i class=\"fa fa-wrench\"></i></th>\n					</tr>\n				</thead>\n				<tbody role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\" id=\"clients\"></tbody>\n			</table>\n		</div>\n	</div>\n</div>\n			";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"col-lg-12\">\n  <h1>\n    Cliente: \n    <span name=\"client_id\"></span>\n    <span class=\"pull-right label label-primary\" name=\"status\" style=\"margin-left: 3px;\"></span>\n    <span id=\"printPDF\" class=\"pull-right btn btn-info\" style=\"margin-left: 3px; padding: 8px; font-size: 16px;\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Imprimir\">\n      <i class=\"fa fa-print fa-fw fa-lg\"></i>\n    </span>\n    <span id=\"downloadPDF\" class=\"pull-right btn btn-info\" style=\"margin-left: 3px; padding: 8px; font-size: 16px;\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Imprimir\">\n      <i class=\"fa fa-download fa-fw fa-lg\"></i>\n    </span>\n  </h1>\n  <hr style=\"margin: 0\">\n  <div class=\"row\">\n    <div class=\"col-sm-6\">\n      <h3>\n        Equipos\n      </h3>\n    </div>\n    <div class=\"col-sm-6\" name=\"invoiceNumber\">\n      <h3 class=\"pull-right\" name=\"invoiceText\">\n        Remito: \n         <span class=\"text-primary\" name=\"invoiceNumber\"></span>\n      </h3>\n    </div>\n  </div>\n  <div id=\"service-request-appliances\"></div>\n</div>\n<div class=\"col-lg-12\">\n<hr>\n  <div class=\"row\">\n    <div class=\"col-sm-6\">\n      <small>\n        Creado el <span name=\"createdAt\"></span> por <span name=\"createdBy\"></span>\n      </small>\n    </div>\n    <div class=\"col-sm-6 text-right\">\n      <small>\n        Modificado el <span name=\"updatedAt\"></span> por <span name=\"updatedBy\"></span>\n      </small>\n    </div>\n  </div>\n</div>";
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\" class=\"table table-striped table-condensed table-bordered table-hover table-office dataTable\" aria-describedby=\"service_requests-table-info\">\n				<thead>\n					<tr>\n						<th>ID</th>\n						<th>Cliente</th>\n						<th>Remito</th>\n						<th>Cant.</th>\n						<th>Estado</th>\n						<th>Creado</th>\n						<th>Cerrado</th>\n						<th class=\"text-center\"><i class=\"fa fa-wrench\"></i></th>\n					</tr>\n				</thead>\n				<tbody role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\" id=\"service_requests\">\n				</tbody>\n			</table>\n		</div>\n	</div>\n</div>";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"col-lg-12\">\n  <span class=\"pull-right\">\n    <a href=\"#render/user/index\" class=\"pull-right text-muted\" style=\"margin-top: 20px\">\n      <i class=\"fa fa-list fa-3x\"></i>\n    </a>\n  </span>\n  <h1>\n    <span name=\"name\"></span>\n    <small name=\"email\">";
  if (stack1 = helpers.email) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.email); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</small>\n  </h1>\n  <hr>\n  <div class=\"row\">\n  	<div class=\"col-lg-12\">\n  		<h3>Permisos:</h3>\n  	</div>\n		<div class=\"col-sm-6\">\n			<h4>Roles</h4>\n			<ul name=\"permissions\"></ul>\n		</div>\n  </div>\n</div>\n<div class=\"col-lg-12\">\n<hr>\n  <div class=\"row\">\n    <div class=\"col-sm-6\">\n      <small>\n        Creado el <span name=\"createdAt\"></span> por <span name=\"createdBy\"></span>\n      </small>\n    </div>\n    <div class=\"col-sm-6 text-right\">\n      <small>\n        Modificado el <span name=\"updatedAt\"></span> por <span name=\"updatedBy\"></span>\n      </small>\n    </div>\n  </div>\n</div>";
  return buffer;
  });
